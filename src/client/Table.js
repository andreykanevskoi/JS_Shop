/*
    Файл        : client/Table.js
    Автор       : Каневской Андрей 
    Описание    : Компонента, содержащая список продуктов из базы.
                : При запуске запрос от клиента отправляется на сервер.
                : Полученный ответ отрисовывается в DataTable модуля 'react-mdl'.
