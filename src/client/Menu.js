/*
    ...
    Описание    : Файл с описанием главной компоненты с контентом.
                ...
                : Внутри отрисовывается: 
                : -- таблица с продуктами (Table),
                : -- верхнее меню навигации с именем текущего пользователя (UserTitle).
                : Также содержит три всплывающих окна:
                : -- регистрация (SignUpDialog),
                : -- авторизация (SignInDialog),
                : -- корзина (CartDialog).
